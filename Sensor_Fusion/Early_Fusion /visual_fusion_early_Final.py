  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/raahul-tavatani/Lidar_Camera_Fusion_Course1/blob/main/Sensor_Fusion/Early_Fusion%20/visual_fusion_early_Final.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "markdown",
    ...
    },
    {
      ...
      "source": [
        ...
        "\n",
        "plt.figure(figsize=(14,7))\n",
        "final_result = lidar2cam.pipeline(image.copy(), points,index,image_files)\n",
    ...
    },
    {
      ...
      "source": [
        ...
        "import os\n",
        "\n",
        "# Get sorted image and point cloud file paths\n",
        "video_images = sorted(glob.glob(\"/content/drive/My Drive/SensorFusion_Lidar_Camera/visual_fusion_course-main/video/images/*.png\"))\n",
        "video_points = sorted(glob.glob(\"/content/drive/My Drive/SensorFusion_Lidar_Camera/visual_fusion_course-main/video/points/*.pcd\"))\n",
        "\n",
        ...
        "    result_video.append(lidar2cam_video.pipeline(image.copy(), point_cloud,idx,video_images))\n",
        "\n",
        "\n",
    ...
    },
    {
      ...
      "source": [
        ...
        "\n",
        "from google.colab import files\n",
        "files.download('output/out_4.mp4')\n"
      ],
      "execution_count": null,
      "outputs": []
    },
